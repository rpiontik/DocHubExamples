...
Если вы придете к архитекторам или шире "к лицам принимающим архитектурные решения" - они вам будут рассказывать абстрактные истории про "TOGAF, Archimate и о том что существуют магические Entarprise архитекторы, которые...". Но для того чтобы начать - вам важно понимать другое:
...
## Настройка инструментария и содание репзитория

Правильные пацаны и девчонки любят следующие консольные утилиты
...
а с исходным кодом работают при помощи

* VSCodium ??? c двумя расширениями
    * dochub
    * markdown
...
> Если лично вы любите продукты JetBrains в качестве IDE - вы конечно же помните что "оно слишком много скрывает", поэтому можете использовать их продукты
...
* [./README.md](./README.md)
* [./src/dochub.yaml](./src/dochub.yaml)
* [./src/docs/intro.md](./src/docs/intro.md)
...
```
docker -v ~./src:/???/arc42 -e ??? run dochub:latest
```
