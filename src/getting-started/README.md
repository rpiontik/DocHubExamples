...
* Мы добавили 2 верхне уровневых компоненты - само предприятие, и класс систем... Нам сейчас так захотелось и это хорошо... Если мы ошиблись - мы поправим это потом
